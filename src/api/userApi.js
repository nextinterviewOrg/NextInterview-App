...
export const createUserProfile = async (data) => {
  const submissionData = {
    ...
    data_scheduled_interview_response:
      data.data_scheduled_interview_response || undefined,
    data_interview_schedule_response:
      data.data_interview_schedule_response || undefined,
    data_interview_scheduled_response:
      data.data_interview_scheduled_response || undefined,
    data_past_interview_response:
      data.data_past_interview_response || undefined,
    ...
    data_planned_interview_response:
      data.data_planned_interview_response || undefined,
  };
  try {
...
export const addPastInterview = async (user_id, data) => {
  try {
    const response = await api.post(
      `users/updateUser/addPastInterview/${user_id}`,
      data
    );
    return response.data;
  } catch (error) {

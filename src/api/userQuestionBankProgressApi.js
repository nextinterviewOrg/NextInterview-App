...
export const checkUserAnswerStatusQuestionBank = async (data) => {
    try {
        /*
        // request body
        {
...
export const addQuestionToQuestionBankProgress = async (data) => {
    try {
        /*
        // request body
        {
        ...
        */
        const response = await api.post(`/userQuestionBankProgress`, data);
        return response.data;
    } catch (error) {
        console.log(error);
        throw error;

    ...
    return (
        <PageWrapper>{
            ...
            <>
                ...
                <TryButton onClick={() => {
                    navigate('/user/mainQuestionBank/qbcodingpage', { state: { questionID: location.state.questionID } })
...
export default QBCodingDetailPage;
